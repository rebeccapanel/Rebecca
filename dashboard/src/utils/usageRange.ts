...
export const buildRangeFromPreset = <Key extends string>(preset: UsagePreset<Key>): RangeState<Key> => {
...
export const normalizeCustomRange = (start: Date, end: Date): RangeState<"custom"> => {
