import { Select, HStack, useColorMode } from "@chakra-ui/react";
...
export const UsageFilter: FC<{ onChange: (filter: string, query: FilterUsageType) => void; defaultValue?: string }> = ({
  onChange,
  defaultValue = "1m",
}) => {
