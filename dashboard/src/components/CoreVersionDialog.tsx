...
export const CoreVersionDialog = ({
  ...
  const releaseOptions = useMemo(() => releasesQuery.data?.tags ?? [], [releasesQuery.data]);
      ...
      <ModalContent>
        ...
        <ModalBody>
          <Stack spacing={4}>
            ...
            <FormControl>
              <FormLabel>{t("nodes.coreVersionDialog.latestReleases")}</FormLabel>
              <Select
                placeholder={
                  isLoadingReleases
                ...
                value={version && releaseOptions.includes(version) ? version : ""}
            ...
            <FormControl isRequired>
              <FormLabel>{t("nodes.coreVersionDialog.customVersionLabel")}</FormLabel>
              <Input
                value={version}
                placeholder={t("nodes.coreVersionDialog.customVersionPlaceholder")}
            ...
            {allowPersist && (
              <Checkbox isChecked={persist} onChange={(event) => setPersist(event.target.checked)}>
