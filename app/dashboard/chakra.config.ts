...
export const theme = extendTheme({
  ...
  styles: {
    global: {
      ":root": {
        // default (previous primary palette)
        "--primary-50": "#9cb7f2",
        "--primary-100": "#88a9ef",
        "--primary-200": "#749aec",
        "--primary-300": "#618ce9",
      ...
      // Dark theme: darker primary colors
      ".rb-theme-dark": {
        "--primary-50": "#1a202c",
        "--primary-100": "#2d3748",
        "--primary-200": "#4a5568",
      ...
      // Ultra Dark: darker accents (good for very dark UIs)
      ".rb-theme-ultra-dark": {
        "--primary-50": "#e6fffa",
        "--primary-100": "#b2f5ea",
        "--primary-200": "#81e6d9",
      ...
      // Moontone (مهتابی): soft cool bluish palette
      ".rb-theme-moontone": {
        "--primary-50": "#ebf8ff",
        "--primary-100": "#dbeafe",
        "--primary-200": "#bfdbfe",
